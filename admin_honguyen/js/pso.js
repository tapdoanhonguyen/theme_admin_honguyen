 ...
 * @Author KHUCTHUYDU.,JSC <3xtran@gmail.com>
 * @Copyright (C) 2022 KHUCTHUYDU.,JSC. All rights reserved
 * @License GNU/GPL version 2 or any later version
 * @Createdate Wed, 25 May 2022 06:31:08 GMT
 */
...
function nv_delete_replace(id) {
    if (confirm(nv_is_del_confirm[0])) {
        $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=replace&nocache=' + new Date().getTime(), 'del=1&id=' + id, function(res) {
            if (res == 'OK') {
                location.reload();
            } else {
                alert(nv_is_del_confirm[2]);
