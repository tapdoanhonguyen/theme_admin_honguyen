    ...
    <header id="header" class="row">
        <div class="logo">
            <a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
                <img class="logo-md" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo-small.png"  height="45"/>
                <img class="logo-xs" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo-xs.png" height="45"/>
            </a>
        </div>
        ...
        <div class="footer-content">
            <div class="copyright">
                ...
                <!-- END: memory_time_usage -->
                  <strong>{NV_COPYRIGHT} -  <a title="NUKEVIET CMS" href="http://tms.vn" target="_blank">{LANG.design_by_3xtran}</a></strong>
            </div>
