    ...
    <body>
        <div id="wrapper">
            ...
            <div class="login-content">
				<!-- BEGIN: logo -->
				<div id="logo">
					<a title="{SITE_NAME}" href="{NV_BASE_SITEURL}"><img src="{NV_BASE_SITEURL}uploads/logo-login.png" class="img-responsive" alt="{SITE_NAME}" /></a>
				</div>
				<!-- END: logo -->
				<div class="tmsloginline">
                ...
                <form class="loginform form-horizontal" method="post" action="{NV_BASE_ADMINURL}index.php" id="admin-login-form">
					<!-- BEGIN: info --><div class="inner-message normal">{GLANG.adminlogininfo}</div><!-- END: info -->
                    <!-- BEGIN: pre_form -->
			...
			<div class="login-footer">
                <div class="row">
					...
					<a id="adm-lostpass" title="{LANGLOSTPASS}" href="{LINKLOSTPASS}" class="btn btn-default btn-sm " ><i class="fa fa-user-circle" aria-hidden="true"></i> {LANGLOSTPASS}?</a>
                    </div>
