		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						<td>{LANG.tb1}</td>
						<td><input class="form-control" name="tb1" value="{DATA.tb1}" /></td>
					</tr>
					<tr>
						<td>{LANG.tb0}</td>
						<td><input class="form-control" name="tb0" value="{DATA.tb0}" /></td>
					</tr>
					<tr>
						<td>{LANG.tb2}</td>
						<td><input class="form-control" name="tb2" value="{DATA.tb2}" /></td>
					</tr>
					<tr>
						<td>{LANG.tb3}</td>
						<td><input class="form-control" name="tb3" value="{DATA.tb3}" /></td>
					</tr>
					...
					<tr>
						<td>{LANG.messenger}</td>
						<td><input class="form-control" name="messenger" value="{DATA.messenger}" /></td>
					</tr>	
					<tr>
						<td>{LANG.zalo}</td>
						<td><input class="form-control" name="zalo" value="{DATA.zalo}" /></td>
					</tr>
					<tr>
						<td>{LANG.skyper}</td>
						<td><input class="form-control" name="skyper" value="{DATA.skyper}" /></td>
					</tr>
					<tr>
						<td>{LANG.whatsapp}</td>
						<td><input class="form-control" name="whatsapp" value="{DATA.whatsapp}" /></td>
					</tr>				
					<tr>
						<td>{LANG.twitter}</td>
