...
<div class="well">
    <form action="{NV_BASE_ADMINURL}index.php" method="get">
        ...
        <div class="row">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control" name="from_date" id="from_date" value="{FROM_DATE}"
                                readonly="readonly" placeholder="{LANG.from_date}">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control" name="to_date" id="to_date" value="{TO_DATE}" 
                                readonly="readonly" placeholder="{LANG.to_date}">
                            <span class="input-group-btn">
			...
			<div class="col-xs-12 col-md-3">
                 <a href="{URL_DOWNLOAD}" target="_blank" class="btn btn-primary">
					<em class="fa fa-download">&nbsp;</em>{LANG.export}</a>
            </div>
        </div>
