		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr id="editorfields" {DATAFORM.editordisabled}>
					...
					<td>
						<div class="row">
							<div class="col-xs-12"><input class="form-control" type="text" value="{DATAFORM.editor_width}" name="editor_width" maxlength="5" placeholder="{LANG.field_width}"></div>
							<div class="col-xs-12"><input class="form-control" type="text" value="{DATAFORM.editor_height}" name="editor_height" maxlength="5" placeholder="{LANG.field_height}"></div>
						</div>
					</td>
				</tr>
			</tbody>
		...
		<table class="table table-striped table-bordered table-hover" id="textfields" {DATAFORM.display_textfields}>
			...
			<tbody>
				...
				<tr id="max_length">
					...
					<td>
						<div class="row">
							<div class="col-xs-3 text-right"><span class="text-middle">{LANG.field_length_min}</span></div>
							<div class="col-xs-9"><input class="form-control number"type="number" value="{DATAFORM.min_length}" name="min_length" placeholder="{LANG.field_length_min}"></div>
							<div class="col-xs-3 text-right"><span class="text-middle">{LANG.field_length_max}</span></div>
							<div class="col-xs-9"><input class="form-control number" type="number" value="{DATAFORM.max_length}" name="max_length" placeholder="{LANG.field_length_max}" /></div>
						</div>
					</td>
				</tr>
			</tbody>
		...
		<table class="table table-striped table-bordered table-hover" id="numberfields" {DATAFORM.display_numberfields}>
			...
			<tbody>
				<tr>
					...
					<td>
						<label><input type="radio" value="1" name="number_type" {DATAFORM.number_type_1}>{LANG.field_integer}</label>&nbsp;
						<label><input type="radio" value="2" name="number_type" {DATAFORM.number_type_2}> {LANG.field_real}</label>
					</td>
				</tr>
				<tr>
					<td>{LANG.field_default_value}</td>
		...
		<table class="table table-striped table-bordered table-hover" id="datefields" {DATAFORM.display_datefields}>
			...
			<tbody>
				<tr>
					<td>{LANG.field_default_value}:</td>
					<td>
						<label><input type="radio" value="1" name="current_date" {DATAFORM.current_date_1}> {LANG.field_current_date}</label>&nbsp;
						<label><input type="radio" value="0" name="current_date" {DATAFORM.current_date_0}> {LANG.field_default_date}</label>&nbsp;
				...
				<tr>
					...
					<td>
						<div class="row">
							<div class="col-xs-12">
								<div class="input-group">
									<input class="form-control datepicker required date" type="text" value="{DATAFORM.min_date}" name="min_date" maxlength="10" placeholder="{LANG.field_date_min}">
									<span class="input-group-btn">
										<button class="btn btn-default" type="button">
											<em class="fa fa-calendar fa-fix">&nbsp;</em>
										</button> </span>
							...
							<div class="col-xs-12">
								<div class="input-group">
									<input class="form-control datepicker required date" type="text" value="{DATAFORM.max_date}" name="max_date" maxlength="10" placeholder="{LANG.field_date_max}">
									<span class="input-group-btn">
										<button class="btn btn-default" type="button">
											<em class="fa fa-calendar fa-fix">&nbsp;</em>
										</button> </span>
