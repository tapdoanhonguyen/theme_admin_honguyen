...
<div class="wizard">
    <a id="badge1" class="current"><span class="badge">1.</span> {LANG.step1}</a> <a id="badge2"><span class="badge">2.</span> {LANG.step2}</a>
</div>
...
<form class="form-horizontal" id="frm-import">
    ...
    <div id="step1">
        ...
        <div class="text-center">
            <button class="btn btn-primary" disabled="disabled" id="btn-import" onclick="nv_change_active(1,2); return !1;">
            ...
            success : function(json) {
                if (json.error) {
                    ...
                    $.each(json.data, function(index, value) {
                        $('#table-check tbody, #table-import tbody').append('<tr id="row-' + index + '"><td>' + value.lastname + '</td><td>' + value.firstname + '</td><td><a href="mailto:' + value.email + '">' + value.email + '</a></td><td class="status"></td></tr>');
                    });
                    total = json.total;
                    count_error = 0;
                    nv_users_readline();
