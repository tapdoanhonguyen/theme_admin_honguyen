    	...
    	<div class="table-responsive">
	        <table class="table table-striped table-bordered table-hover">
	            <tbody>
					...
					<tr>
	                    <td>{LANG.config_detail_replace_other}</td>
	                    <td>
	                    	<!-- BEGIN: detail_replace_other -->
							<label><input type="checkbox" name="detail_replace_other[]" value="{REPLACE_OTHER.key}" {REPLACE_OTHER.checked} />{REPLACE_OTHER.value}</label>&nbsp;&nbsp;&nbsp;
							<!-- END: detail_replace_other -->
	                    </td>
	                </tr>
	                <tr>
	                    <td>{LANG.config_detail_replace_other_numlinks}</td>
	                    <td>
							<input class="form-control w200 pull-left" type="text" name="replace_other_numlinks" value="{DATA.replace_other_numlinks}"/>
	                    </td>
	                </tr>
	                <tr>
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div><label><input type="checkbox" name="detail_show_link_type" value="1"{DATA.detail_show_link_type}/>&nbsp;{LANG.config_show_link_detailpage5}</label></div>
